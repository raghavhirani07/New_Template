                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <a class="post-img" href="single.php?id=<?php echo $row['post_id']; ?>"><img
                                                                    src="admin/upload/<?php echo $row['post_img']; ?>" alt="Image Not Found " /></a>
                                                        </div>
                                                        <div class="col-md-8">
                                                            <div class="inner-content clearfix">
                                                                ...
                                                                <div class="post-information">
                                                                    ...
                                                                    <span>
                                                                        ...
                                                                        <a
                                                                            href='author.php?aid=<?php echo $row['user_id'];?>'><?php echo $row['first_name'].' '.$row['last_name']; ?></a>
                                                                    </span>
                                                                    <span>
                    ...
                    <?php
                                    ...
                                    $result1=mysqli_query($conn,$sql1) or die ("Query Failed ");
                                        if( mysqli_num_rows($result1)>0)
                                        {
                                            ...
                                            if($page > 1){
                                            echo '<li><a href="search.php?search='.$search.'&page='.($page - 1).'">Pre</a></li>';
                                            }
                                            for($i;$i <=$totalpage;$i++)
                                            {
                                                if($page == $i){
